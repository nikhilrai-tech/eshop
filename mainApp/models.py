...
class CheckoutProducts(models.Model):
    ...
    def __str__(self):
        return "id = "+str(self.id)+" "+"checkout id = "+str(self.checkout.id)
...
conatctStatusChoice = ((1,"Active"),(2,"Done"))
class Contact(models.Model):
    ...
    status = models.IntegerField(choices=conatctStatusChoice,default=1)
