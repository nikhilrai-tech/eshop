...
def shop(request,mc,sc,br):
    if(request.method=="POST"):
        ...
        if(mc=="All" and sc=="All" and br=="All"):
            ...
            products = Product.objects.filter(brand=Brand.objects.get(name=br),subcategory=Subcategory.objects.get(name=sc))
        else:
            products = Product.objects.filter(maincategory=Maincategory.objects.get(name=mc),brand=Brand.objects.get(name=br),subcategory=Subcategory.objects.get(name=sc))
    products=products[::-1]
        ...
        if(type=="seller"):
            ...
            if(password==cpassword):
                try:
                    ...
                    message = ''''
                        ...
                        Now you can sell product with us
                        visit for latest product and offerse
                        http://localhost:8000/
                        Team : Eshop.com
                        '''
            ...
            if(password==cpassword):
                try:
                    ...
                    message = ''''
                        Thanks to create account in our site
                        Now you can Buy product from us
                        visit for latest product and offerse
                        http://localhost:8000/
                        Team : Eshop.com
                        '''
